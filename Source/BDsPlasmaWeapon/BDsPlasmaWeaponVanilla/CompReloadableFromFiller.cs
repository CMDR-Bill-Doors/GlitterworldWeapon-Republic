...
namespace BDsPlasmaWeaponVanilla
{
    ...
    public class JobGiver_ReloadFromFiller : ThinkNode_JobGiver
    {
        ...
        public static Thing FindFiller(Pawn pawn)
        {
            ...
            {
                CompResource compfiller = x.TryGetComp<CompResource>();
                if (compfiller != null)
                {
    ...
    public class JobDriver_ReloadFromFiller : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            PipeNet filler = job.GetTarget(TargetIndex.B).Thing.TryGetComp<CompResource>().PipeNet; int LizionAvaliable = (int)filler.Stored;
